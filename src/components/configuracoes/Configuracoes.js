...
const Configuracoes = () => {
  ...
  const handlePerfilSubmit = async (e) => {
    ...
    try {
      await updateUserProfile(userProfile?.uid, perfilData);
              ...
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => setPerfilData({...perfilData, displayName: e.target.value})}
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-gray-500">Notificar sobre novas rotas atribuídas</p>
                </div>
                <button
              ...
              <div className="flex items-center justify-between">
                <div>
                  <h4 className="text-sm font-medium text-gray-900">Solicitações de Folga</h4>
                  <p className="text-sm text-gray-500">Notificar sobre solicitações de folga</p>
                </div>
                <button
              ...
              <div className="flex items-center justify-between">
                <div>
                  <h4 className="text-sm font-medium text-gray-900">Manutenção de Veículos</h4>
                  <p className="text-sm text-gray-500">Alertas sobre manutenção programada</p>
                </div>
                <button
                ...
                >
                  <span
                    className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
                      notificacoes.manutencao ? 'translate-x-6' : 'translate-x-1'
                    }`}
                  />
                </button>
              </div>
                ...
                <div className="flex">
                  ...
                  <div className="ml-3">
                    ...
                    <div className="mt-2 text-sm text-blue-700">
                      <p>Último login: {userProfile?.lastLogin ? new Date(userProfile.lastLogin.toDate()).toLocaleString('pt-BR') : 'N/A'}</p>
