...
import { BarChart3, Download, Calendar, Users, Truck, Route } from 'lucide-react';
...
const Relatorios = () => {
  ...
  const processarDadosVeiculos = (veiculos) => {
    ...
    const dados = [
      { name: 'Disponível', value: statusCount.disponivel || 0, color: '#10B981' },
      { name: 'Em Uso', value: statusCount.em_uso || 0, color: '#3B82F6' },
      { name: 'Manutenção', value: statusCount.manutencao || 0, color: '#F59E0B' },
  ...
  const processarDadosRotas = (rotas) => {
    ...
    const dados = [
      ...
      { name: 'Concluída', value: statusCount.concluida || 0, color: '#10B981' },
      { name: 'Cancelada', value: statusCount.cancelada || 0, color: '#EF4444' }
    ];
  ...
  const processarDadosFolgas = (folgas) => {
    ...
    const dados = [
      ...
      { name: 'Rejeitada', value: statusCount.rejeitada || 0, color: '#EF4444' }
    ];
      ...
      <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div className="card">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-semibold text-gray-900">
                {dadosRotas.filter(item => item.name === 'Em Andamento')[0]?.value || 0}
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="card">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <p className="text-sm font-medium text-gray-600">Folgas Pendentes</p>
              <p className="text-2xl font-semibold text-gray-900">
                {dadosFolgas.filter(item => item.name === 'Pendente')[0]?.value || 0}
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
        ...
        <div className="card">
          <div className="flex justify-between items-center mb-4">
            <h3 className="text-lg font-medium text-gray-900">Status dos Motoristas</h3>
            <button
        ...
        <div className="card">
          <div className="flex justify-between items-center mb-4">
            <h3 className="text-lg font-medium text-gray-900">Status dos Veículos</h3>
            <button
        ...
        <div className="card">
          <div className="flex justify-between items-center mb-4">
            <h3 className="text-lg font-medium text-gray-900">Status das Rotas</h3>
            <button
        ...
        <div className="card">
          <div className="flex justify-between items-center mb-4">
            <h3 className="text-lg font-medium text-gray-900">Status das Folgas</h3>
            <button
